                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h4 class="media-heading"><a
                                        href="<?= Url::to(["/catalog/category", "catalias" => $project->catprod->alias, "id" => $project->id]) ?>"><?= $project->title ?></a>
                                <strong>#</strong><?= $project->id ?></h4>
                            <div class="clr"></div>
                            <?= StarRating::widget([
                            ...
                            <div class="col-md-12 actions">
                                ...
                                <a class="btn btn-danger btn-xs deletemyproject" href="#" data-id="<?= $project->id ?>"><span
